...
import { LuScanSearch, LuShieldCheck, LuCopyCheck, LuGavel, LuSquareArrowUpRight } from 'react-icons/lu';
		...
		<>
					...
					<div className="flex flex-col md:flex-row md:space-x-2">
						<div className="flex-1 flex flex-col text-center items-center">
							<div className="md:space-y-4 space-y-1">
								...
								<h1 className="text-base sm:text-xl md:text-2xl">Enterprise-grade security management.</h1>
								<h1 className="text-xl sm:text-2xl md:text-4xl">For every business.</h1>
							...
							<div className="mt-6 sm:mt-8 md:mt-10 w-fit justify-center space-y-2">
								...
								<p className="text-gray-300 text-xs sm:text-base md:text-lg">
									It&apos;s a trusted partner that helps you navigate the ever-evolving cybersecurity landscape.
								</p>
								<p className="text-gray-300 text-xs sm:text-base md:text-lg">We&apos;ve got you covered. 24x7.</p>
							</div>
			...
			<section>
				<div className="flex justify-center mt-10 sm:-mt-6 md:-mt-8">
					<p className="text-xs sm:text-sm text-gray-400">Trusted by fast-growing companies worldwide</p>
				</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 mt-14 2xl:px-72">
					<div className="flex md:justify-start justify-center">
						<p className="font-mono text-sm text-teal-600 tracking-wider">THE CHAOS OF COMPLEXITY</p>
					</div>
					...
					<p className="mt-4 text-gray-500 text-center md:text-left">
						The modern cybersecurity landscape is increasingly fragmented and complex.
					</p>
									...
									<div className="flex flex-col gap-2">
										<div className="z-[60] flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-center md:justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">Unauthorized access to customer PII</span>
											</div>
										...
										<div className="-mt-4 z-[50] -translate-x-4 flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">Compliance score dropped by 40%</span>
											</div>
										...
										<div className="-mt-4 z-[40] flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">Unpatched vulnerabilities exploited</span>
											</div>
											<span className="uppercase text-[8px] border rounded-xl px-1 text-red-400 border-red-400 font-mono">
												critical
											</span>
										...
										<div className="-mt-4 z-[30] translate-x-4 flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">17 Critical vulnerabilities discovered</span>
											</div>
											<span className="uppercase text-[8px] border rounded-xl px-1 text-red-400 border-red-400 font-mono">
												critical
											</span>
										...
										<div className="-mt-4 z-[20] -translate-x-4 flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">ZTNA not enforced</span>
											</div>
										...
										<div className="-mt-4 z-[10] flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">Abnormal network traffic detected</span>
											</div>
											<span className="uppercase text-[8px] border rounded-xl px-1 border-amber-300 text-amber-300 font-mono">
												warning
											</span>
										...
										<div className="-mt-4 z-[5] -translate-x-4 flex gap-2 items-center rounded-lg p-2 bg-neutral-900 border border-neutral-800 shadow-lg justify-between md:hover:-translate-y-1 transition-all duration-300 ease-in-out">
											<div className="flex items-center gap-1">
												...
												<span className="text-sm text-gray-400">23 Policies need attention</span>
											</div>
											<span className="uppercase text-[8px] border rounded-xl px-1 border-amber-300 text-amber-300 font-mono">
												warning
											</span>
					...
					<div className="flex gap-2 mt-10">
						<div className="grid md:grid-cols-4 grid-cols-2 gap-2">
							<div className="flex flex-col justify-between space-y-4 border p-4 rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60">
								...
								<p className="text-sm text-gray-500">of enterprises use 10+ security tools, yet breaches still rise</p>
							</div>
							<div className="flex flex-col justify-between space-y-4 border p-4 rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60">
								<div className="flex items-center justify-between">
									<span>
								...
								<p className="text-sm text-gray-500">delay in incident response due to manual processes</p>
							</div>
							<div className="flex flex-col justify-between space-y-4 border p-4 rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60">
								<div className="flex items-center justify-between">
									<span>
								...
								<p className="text-sm text-gray-500">of CISOs say third-party risks are their #1 blind spot</p>
							</div>
							<div className="flex flex-col justify-between space-y-4 border p-4 rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60">
								<div className="flex items-center justify-between">
									<span>
								...
								<p className="text-sm text-gray-500">
									of compliance violations stem from inconsistent policy enforcement across hybrid environments
								</p>
							</div>
						</div>
					</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 mt-14 2xl:px-72">
					<div className="flex flex-col justify-center items-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider">CHAOS TO CONTROL</p>
						<p className="md:text-3xl text-2xl">Safeguard Your Organization</p>
						<p className="text-gray-500 text-center">Prevent breaches, ensure continuity, and secure trust</p>
					</div>
					<div className="grid md:grid-cols-3 md:gap-4 md:space-y-0 space-y-2">
						<div className="flex flex-col border bg-kite-dark-2 border-neutral-800 bg-opacity-60 rounded-lg p-4 space-y-4">
							...
							<div className="flex flex-col space-y-1">
								...
								<span className="text-sm text-gray-500">
									Proactively identifying cybersecurity risks is crucial to safeguard sensitive data, ensure business
									continuity, prevent costly breaches, and avoid regulatory fines or reputational damage in today’s
									threat-driven digital ecosystem.
								</span>
							</div>
						</div>
						<div className="flex flex-col border rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60 p-4 space-y-4">
							...
							<div className="flex flex-col space-y-1">
								...
								<span className="text-sm text-gray-500">
									Prioritizing cybersecurity vulnerabilities enables organizations to mitigate critical risks, allocate
									resources efficiently, and minimize operational disruptions, building resilience against evolving
									cyber threats.
								</span>
							</div>
						</div>
						<div className="flex flex-col border rounded-lg bg-kite-dark-2 border-neutral-800 bg-opacity-60 p-4 space-y-4">
							...
							<div className="flex flex-col space-y-1">
								...
								<span className="text-sm text-gray-500">
									Timely remediation of cybersecurity threats eliminates vulnerabilities, blocks potential breaches, and
									secures business operations, ensuring long-term resilience and stakeholder trust in a dynamic threat
									landscape.
								</span>
							</div>
						</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 mt-14 2xl:px-72">
					<div className="flex flex-col justify-center items-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider">TOWARDS CYBER RESILIENCE</p>
						<p className="md:text-3xl text-2xl text-center">One platform. Enterprise-grade. Hexafort Secure.</p>
						<p className="text-gray-500 text-center">
							Manage your end-to-end security posture from a single platform, Hexafort Secure
						</p>
					</div>
						...
						<div className="flex flex-col gap-6 justify-center">
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									<span>Detection</span>
									<span className="text-sm text-gray-500">
										Spot threats instantly with real-time monitoring and advanced analytics.
									</span>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									...
									<span className="text-sm text-gray-500">
										Block attacks before they strike with proactive defenses and risk mitigation.
									</span>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									<span>Response</span>
									<span className="text-sm text-gray-500">
										Act fast and minimize damage with automated, expert-guided incident response.
									</span>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									...
									<span className="text-sm text-gray-500">
										Stay compliant and in control with scalable policy and risk management.
									</span>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									...
									<span className="text-sm text-gray-500">
										Streamline security tasks and boost efficiency with intelligent automation.
									</span>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div className="flex flex-col gap-1">
									...
									<span className="text-sm text-gray-500">
										Gain full insight into your security posture with comprehensive visibility.
									</span>
								</div>
							</div>
						</div>
					...
					<div className="grid md:grid-cols-4 gap-2">
						<div className="flex flex-col rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60 p-4 space-y-4 justify-between">
							...
							<div className="flex gap-1 items-baseline">
								...
								<span className="text-sm text-gray-400">Compliance and risk management, simplified.</span>
							</div>
							<div className="space-y-3">
								...
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									...
									<span className="text-sm text-gray-400">Real-time Compliance Posture</span>
								</div>
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
										<FaBolt />
									</span>
									<span className="text-sm text-gray-400">Third-Party Risk Assessment</span>
								</div>
							</div>
						</div>
						...
						<div className="flex flex-col rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60 p-4 space-y-4 justify-between">
							...
							<div className="flex gap-1 items-baseline">
								...
								<span className="text-sm text-gray-400">Stay ahead of threats with proactive defense.</span>
							</div>
							<div className="space-y-3">
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
									...
									<span className="text-sm text-gray-400">Threat Management</span>
								</div>
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
										<FaBolt />
								...
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									...
									<span className="text-sm text-gray-400">Vulnerability Management</span>
								</div>
							</div>
						</div>
						...
						<div className="flex flex-col rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60 p-4 space-y-4 justify-between">
							...
							<div className="flex gap-1 items-baseline">
								...
								<span className="text-sm text-gray-400">Protect your data with precision and control.</span>
							</div>
							<div className="space-y-3">
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
									...
									<span className="text-sm text-gray-400">Data Privacy Management</span>
								</div>
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
										<FaBolt />
									</span>
									<span className="text-sm text-gray-400">Access Management</span>
								</div>
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
										<FaBolt />
									</span>
									<span className="text-sm text-gray-400">Data Flow Monitoring System</span>
								</div>
							</div>
						</div>
						...
						<div className="flex flex-col rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60 p-4 space-y-4 justify-between">
							...
							<div className="flex gap-1 items-baseline">
								...
								<span className="text-sm text-gray-400">Secure your cloud and endpoint assets with ease.</span>
							</div>
							<div className="space-y-3">
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
								...
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									...
									<span className="text-sm text-gray-400">Cloud Asset Inventory</span>
								</div>
								<div className="flex gap-1 items-center rounded-lg px-2 py-1 border-neutral-700 text-gray-500 bg-neutral-800">
									<span className="text-xs text-teal-600">
										<FaBolt />
									</span>
									<span className="text-sm text-gray-400">Endpoint Asset Monitoring</span>
								</div>
							</div>
						</div>
					</div>
			...
			<section>
				<div className="flex flex-col md:flex-row px-6 md:px-48 md:mt-40 space-x-8 items-center mt-14 2xl:px-72">
					<div className="flex flex-col md:flex-1 justify-center space-y-2">
						...
						<p className="md:text-3xl text-2xl text-center md:text-left">Clear Steps, No Surprises</p>
						<p className="text-gray-500 text-center md:text-left">
							From Assessment to Evolution: A Dynamic Cybersecurity Framework to Defend, Comply, and Thrive
						</p>
					</div>
						...
						<div className="grid md:grid-cols-2 gap-8">
							<div className="space-y-4">
								...
								<div>
									<p>Assessment</p>
									<p className="text-sm text-gray-500">
										We start with a comprehensive security assessment to identify your unique risks and vulnerabilities.
									</p>
								</div>
							</div>
							...
							<div className="space-y-4">
								...
								<div>
									<p>Implementation</p>
									<p className="text-sm text-gray-500">
										We implement Hexafort Secure, tailoring the solution to meet your specific security needs and
							...
							<div className="space-y-4">
								...
								<div>
									...
									<p className="text-sm text-gray-500">
										Our team provides ongoing monitoring and management, ensuring your systems are protected and
										compliant.
									</p>
								</div>
							</div>
							...
							<div className="space-y-4">
								...
								<div>
									...
									<p className="text-sm text-gray-500">
										We constantly evolve and innovate, providing you with the latest security technologies and best
										practices.
									</p>
								</div>
							</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 items-center mt-14 2xl:px-72">
					<div className="flex flex-col items-center justify-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider text-center">BUILD WITH HEXAFORT</p>
						<p className="md:text-3xl text-2xl text-center">We are your Cyber Security Ally</p>
						<p className="text-gray-500 text-center">
							We will take care of your cyber security headaches while you build your business
						</p>
					</div>
					<div className="grid md:grid-cols-3 gap-4">
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Build organizational resilience with employee training, phishing simulations, and zero-trust policies.
								</p>
							</div>
						</div>
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Simplify audits with real-time compliance dashboards and automated evidence collection.
								</p>
							</div>
						</div>
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Access continuous product updates informed by our global threat research team and MITRE ATT&CK
									insights.
								</p>
							</div>
						</div>
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Monthly executive briefings, threat landscape reports, and ROI-driven metrics keep you informed and
									empowered.
								</p>
							</div>
						</div>
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Stay ahead with AI/ML-driven security and threat-informed defense strategies.
								</p>
							</div>
						</div>
						<div className="space-y-4 p-4 rounded-lg bg-kite-dark-2 border border-neutral-800 bg-opacity-60">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-gray-500">
									Achieve measurable cost savings, compliance confidence, and breach prevention.
								</p>
							</div>
						</div>
					</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 items-center mt-14 2xl:px-72">
					<div className="flex flex-col items-center justify-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider text-center">OUR PRESENCE</p>
						<p className="md:text-3xl text-2xl text-center">Driven by Expertise, Serving Clients Worldwide</p>
						<p className="text-gray-500 text-center">
							Global Reach, Unmatched Expertise, Tailored Solutions for Every Client
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-2">
						...
						<div className="flex flex-col border rounded-lg p-4 bg-kite-dark-2 border-neutral-800 bg-opacity-60 space-y-4">
							...
							<p className="text-sm text-gray-400">
								Our team of security professionals offers deep expertise and vast experience in protecting organizations
								of all scales.
							</p>
						</div>
						<div className="flex flex-col border rounded-lg p-4 bg-kite-dark-2 border-neutral-800 bg-opacity-60 space-y-4">
							...
							<p className="text-sm text-gray-400">
								We deliver customized solutions designed to address the specific security requirements of our varied
								clientele.
							</p>
						</div>
					</div>
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 items-center mt-14 2xl:px-72">
					<div className="flex flex-col items-center justify-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider text-center">PARTNER STORIES</p>
						<p className="md:text-3xl text-2xl text-center">We Thrive on Our Relationships</p>
						<p className="text-gray-500 text-center">
							Building Strong Partnerships Through Trust, Excellence, and Collaboration
						</p>
					</div>
					<div className="grid md:grid-cols-3 gap-4">
						<div
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;They are experts at understanding the nuances of different data security and compliance
								requirements. As a result, they were extremely helpful in identifying areas for us to address in a
								timely manner. They are pleasant to work with and capable of meeting our company&apos;s data protection
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;As the CFO of Dartle, a SaaS analytics platform revolutionizing sports academies, data security
								and compliance are critical to our operations. Hexafort has been a game-changer in ensuring our
								financial and athlete performance data remain secure and compliant with industry standards. Their robust
								security infrastructure and proactive threat management have given us the confidence to scale without
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;Team was swift and helpful with the communication. Got the certifications done, and appreciate the
								effort Hexafort team has put. User friendly pricing and I recommend it.&quot;
							</p>
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;As a virtual CISO and DPO I have relied on Hexafort to deliver support with ISO 27001 compliance.
								They completed a very detailed and useful internal audit prior to the external certification audit which
								ensured we had zero findings on the external certification audit report. The Hexafort team have a number
								of SMEs and nothing is too much trouble. I find Hexafort a pleasure to work with and am looking forward
								to working with them further on other projects.&quot;
							</p>
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;In a short span of time, the Hexafort team really understood the requirements of our organization
								and provided excellent support and assistance. The team&apos;s proactive approach, responsiveness, and
						...
						>
							...
							<p className="text-sm italic text-gray-300">
								&quot;Hexafort&apos;s expertise in cloud security and risk management has not only streamlined our
			...
			<section>
				<div className="flex flex-col px-6 md:px-48 md:mt-40 space-y-8 items-center mt-14 2xl:px-72">
					<div className="flex flex-col items-center justify-center space-y-2">
						<p className="font-mono text-sm text-teal-600 tracking-wider text-center">FREQUENTLY ASKED QUESTIONS</p>
						<p className="md:text-3xl text-2xl text-center">Your Questions, Our Commitment</p>
						<p className="text-gray-500 text-center">
