    ...
    <Box sx={notFoundStyle.section}>
      ...
      <Container sx={notFoundStyle.container}>
        <Box sx={notFoundStyle.contentBox}>
          <Typography sx={notFoundStyle.errorCode}>
            404
          </Typography>
          ...
          <Typography variant="body1" sx={notFoundStyle.description}>
            The page you're looking for doesn't exist or has been moved. Let's get you back on track to secure your organization.
          </Typography>
          ...
          <Box sx={notFoundStyle.linkContainer}>
            <Box component="ul" sx={notFoundStyle.resourceList}>
              <Box component="li" sx={notFoundStyle.listItem}>
                <Link href="/platform" style={notFoundStyle.linkStyle}>
              ...
              <Box component="li" sx={notFoundStyle.listItem}>
                <Link href="/resources" style={notFoundStyle.linkStyle}>
          ...
          <Box sx={notFoundStyle.buttonContainer}>
            <Link href="/" passHref style={{ textDecoration: 'none' }}>
              <Button sx={notFoundStyle.primaryButton}>
                Go Home
              </Button>
            </Link>

            <Link href="/contact" passHref style={{ textDecoration: 'none' }}>
              <Button sx={notFoundStyle.secondaryButton}>
                Contact Support
              </Button>
            </Link>
          </Box>
