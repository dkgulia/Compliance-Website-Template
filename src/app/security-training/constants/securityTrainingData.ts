  ...
  sections: [
    ...
    },
    {
      ...
      content: {
        ...
        title: 'How It Works',
        subtitle: 'Get your security training program running in four simple steps',
        steps: [
          {
    ...
    },
    {
      ...
      content: {
        ...
        benefits: [
          ...
          'Pre-built lesson templates included',
          'Automated user role assignments',
    ...
    },
    {
      ...
      content: {
        ...
        subtitle: 'Get answers to the most common questions about our training platform',
        questions: [
          {
            question: 'How often are lessons updated?',
            answer:
              'Our content team releases new lessons weekly, with updates to existing content based on emerging threats and compliance requirements.',
          },
          {
          ...
          },
          {
            ...
            answer: 'Export completion certificates, training transcripts, and detailed analytics in multiple formats for any audit requirement.',
          },
          {
            question: 'What frameworks does training map to?',
            answer:
              'SOC 2, ISO 27001, PCI DSS, HIPAA, GDPR, NIST, and custom compliance frameworks with detailed mapping documentation.',
          },
        ],
      },
    },
