...
export const thirdPartyRiskManagementData = {
    pageTitle: "ComplianceHub Third-Party Risk Management Module | AI-Driven Third-Party Risk Management",
    pageSubTitle: "Simplify third-party evaluation, assessment, and continuous monitoring with real-time risk insights.",
    pageDescription:
        "ComplianceHub's Third-Party Risk Management Module simplifies the process of evaluating, assessing, and monitoring your vendors and third parties. With AI-powered automated questionnaire answering, real-time risk assessments, and actionable insights, you can ensure strong, secure, and compliant vendor relationships—all from one easy-to-use platform.",
    keywords: [
        "vendor management",
    ...
    hero: {
        ...
        description: [
            "ComplianceHub's Third-Party Risk Management Module simplifies the process of evaluating, assessing, and monitoring your vendors and third parties.",
    ...
    benefits: {
        title: "Why ComplianceHub Third-Party Risk Management?",
    ...
    pitfalls: {
        ...
        list: [
            {
                heading: "Siloed Data",
                subheading: "ComplianceHub centralizes third-party records for single-source truth."
            },
            {
    ...
    faq: {
        ...
        questions: [
            ...
            {
                question: "Does ComplianceHub provide third-party risk management solutions?",
                answer: "Yes. ComplianceHub's Third-Party Risk Management Module offers end-to-end third-party evaluation, risk assessment, and monitoring."
            },
            {
                question: "How do I get started with ComplianceHub Third-Party Risk Management?",
