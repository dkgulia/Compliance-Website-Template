...
const TestimonialSection: React.FC = () => {
 ...
 return (
   <Box sx={testimonialSectionStyle.section}>
     <Box sx={testimonialSectionStyle.headerContainer}>
       <Typography sx={testimonialSectionStyle.tagline}>TESTIMONIALS</Typography>
       <Typography sx={testimonialSectionStyle.title}>
