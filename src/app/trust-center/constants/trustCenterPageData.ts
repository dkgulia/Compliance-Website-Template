...
export const trustCenterPageData = {
 ...
 sections: {
   ...
   benefits: {
     ...
     subtitle: 'Four standout advantages that set you apart from the competition',
     features: [
       {
   ...
   workflow: {
     tagline: 'IMPLEMENTATION PROCESS',
     title: 'How It Works',
     subtitle: 'A streamlined four-step workflow to get you up and running',
     steps: [
       {
       ...
       },
       {
         ...
         image: '/images/trust-center/brand-configure.png',
       },
       {
         ...
         icon: LockIcon,
         image: '/images/trust-center/access-rules.png',
       },
       {
         ...
         icon: InsightsIcon,
         image: '/images/trust-center/share-track.png',
       },
     ],
   },
   infoSection1: {
     tagline: 'SECURITY SHOWCASE',
   ...
   features: {
     ...
     subtitle: 'Everything you need in one secure, comprehensive portal',
     features: [
       {
   ...
   pitfalls: {
     tagline: 'COMMON CHALLENGES',
     title: 'Common Trust Center Pitfalls (Solved)',
     subtitle: 'Avoid these four critical blockers that slow down sales cycles',
     items: [
       {
         heading: 'Static PDFs',
   ...
   cta: {
     ...
     image: '/images/trust-center/demo-laptop.png',
     benefits: [
       'Live demo of Trust Center features',
       'Personalized implementation roadmap',
       'Security questionnaire template pack',
   ...
   faq: {
     ...
     subtitle: 'Get answers to the most common questions about our Trust Center',
     questions: [
       {
