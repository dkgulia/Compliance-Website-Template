                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box sx={heroSectionStyle.textContent}>
                            ...
                            <Typography variant="body1" sx={heroSectionStyle.heroDescription}>
                                The General Data Protection Regulation (GDPR) transformed how organizations
                                handle personal data. Beyond being a legal mandate, GDPR is a framework for
                                protecting individuals' privacy rights in a globalized, data-driven economy.
                            </Typography>
