      ...
      <Container maxWidth="lg">
        <Box sx={styles.headerBoxStyle as any}>
          ...
          <Typography sx={styles.headerDescriptionStyle}>
            Welcome to Hexafort Secure Private Limited ("Hexafort", "we", "our",
        ...
        <Box sx={styles.sectionStyle} id="introduction">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort Secure Private Limited ("Hexafort") is a global provider of
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            of Hexafort’s cybersecurity services, including any associated
        ...
        <Box sx={styles.sectionStyle} id="definitions">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            offerings made available by Hexafort via its SaaS platform. This
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            into a subscription or commercial agreement with Hexafort to use the
            Service.
          </Typography>
          <Typography sx={styles.paragraphStyle}>
          ...
          <Typography sx={styles.paragraphStyle}>
            "Hexafort", "we", "us", or "our" means Hexafort Secure Private
        ...
        <Box sx={styles.sectionStyle} id="eligibility">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort welcomes users of all backgrounds, identities, and
        ...
        <Box sx={styles.sectionStyle} id="account-registration">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            updated at all times. Hexafort reserves the right to suspend or
          ...
          <Typography sx={styles.paragraphStyle}>
            While Hexafort employs robust access controls and encryption
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            account’s security. Additionally, Hexafort may impose limits or
            ...
            integrity of the platform and other users. Hexafort will not be
        ...
        <Box sx={styles.sectionStyle} id="subscription">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort offers a range of subscription-based plans tailored to meet
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            Hexafort. Failure to make timely payments or declined transactions
        ...
        <Box sx={styles.sectionStyle} id="free-trials">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort may, at its sole discretion, offer free trials, beta
            ...
            determined exclusively by Hexafort, which reserves the right to
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            however, if provided, users authorize Hexafort to automatically
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            unless explicitly authorized. Hexafort reserves the right to modify,
        ...
        <Box sx={styles.sectionStyle} id="intellectual-property">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            on or through the Service, are the exclusive property of Hexafort or
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            in writing by Hexafort. Any unauthorized use of our intellectual
        ...
        <Box sx={styles.sectionStyle} id="privacy-and-security">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort is committed to protecting your data and ensuring your
        ...
        <Box sx={styles.sectionStyle} id="availability">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort is committed to ensuring the continuous availability of the
          ...
          <Typography sx={styles.paragraphStyle}>
            In such cases, Hexafort cannot be held responsible for any resulting
        ...
        <Box sx={styles.sectionStyle} id="termination">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort reserves the right to suspend or terminate your access to
        ...
        <Box sx={styles.sectionStyle} id="refund">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort operates on a pay-as-you-use model, and as such, we do not
        ...
        <Box sx={styles.sectionStyle} id="liability">
          ...
          <Typography sx={styles.paragraphStyle}>
            To the maximum extent permitted by applicable law, Hexafort shall
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            Hexafort’s total cumulative liability for any claims arising under
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            you and Hexafort, and without it, we would not be able to offer the
        ...
        <Box sx={styles.sectionStyle} id="disclaimer">
          ...
          <Typography sx={styles.paragraphStyle}>
            The Service is provided by Hexafort on an “as is” and “as available”
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            title, and non-infringement. Hexafort makes no representation or
        ...
        <Box sx={styles.sectionStyle} id="indemnification">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            protect, defend, and hold harmless Hexafort, its affiliates,
            ...
            for Hexafort, you will assist in resolving it and cover any
        ...
        <Box sx={styles.sectionStyle} id="modifications">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort may update or modify these Terms and Conditions from time
        ...
        <Box sx={styles.sectionStyle} id="beta-features">
          ...
          <Typography sx={styles.paragraphStyle}>
            From time to time, Hexafort may offer access to beta features,
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            Hexafort shall not be liable for any issues, data loss, or
        ...
        <Box sx={styles.sectionStyle} id="third-party-services">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            operations. While Hexafort facilitates these integrations to provide
            a seamless experience, the choice, configuration, and use of any
            third-party service are made solely by you. Hexafort does not
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            reviewing those terms carefully. Hexafort’s responsibility is
        ...
        <Box sx={styles.sectionStyle} id="force-majeure">
          ...
          <Typography sx={styles.paragraphStyle}>
            Hexafort shall not be held responsible or liable for any failure or
          ...
          <Typography sx={styles.paragraphStyle}>
            In the event of a force majeure situation, Hexafort will make
        ...
        <Box sx={styles.sectionStyle} id="feedback">
          ...
          <Typography sx={styles.paragraphStyle}>
            ...
            Hexafort, you acknowledge and agree that we may use, reproduce,
          ...
          <Typography sx={styles.paragraphStyle}>
            Thank you for using Hexafort's services responsibly.
          </Typography>
        </Box>
      </Container>
    </Box>
