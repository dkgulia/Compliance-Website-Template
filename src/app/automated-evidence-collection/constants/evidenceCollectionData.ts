...
export const evidenceCollectionData = {
  pageTitle:
    'Hexafort Automated Evidence Collection | Compliance Proof on Autopilot',
  pageSubTitle:
    'Gather, map, and monitor audit evidence—without spreadsheets or manual uploads.',
  pageDescription: [
  ...
  cta: {
    ...
    subtitle: '',
    description:
      'See how automated evidence collection keeps you audit-ready year-round.',
