...
const aboutUsData = {
  ...
  values: {
    ...
    items: [
      {
        title: "Trustworthy",
        description: "We build lasting relationships based on transparency and integrity. Security is built on trust, and we strive to be the most trusted partner for our clients' compliance and security needs.",
        icon: ShieldIcon
      },
      {
        title: "Security-First",
        description: "We believe compliance is an outcome, but security is a behavior. Our approach prioritizes real protection over checkbox exercises, ensuring businesses remain both compliant and truly secure.",
        icon: SecurityIcon
      },
      {
        title: "Innovative",
        description: "We continuously innovate with AI-driven solutions to stay ahead of evolving security challenges, making the complex simple and the manual automatic.",
        icon: AutomationIcon
      },
      {
        title: "Client-Focused",
        description: "We're committed to helping our clients transform security from a burden into a strategic advantage, ensuring they can grow and scale with confidence.",
        icon: HandshakeIcon
      }
    ]
  },
    ...
    items: [
      {
        ...
        description: "While others focus on compliance checkboxes, we prioritize comprehensive security posture management.",
        icon: ShieldIcon
      },
      {
        title: "AI-Powered Intelligence",
        description: "Our platform combines AI security governance, real-time risk intelligence, and proactive threat monitoring.",
        icon: InsightsIcon
      },
      {
        title: "Seamless Automation",
        description: "Automate up to 70% of compliance tasks, cut audit prep time by 50%, and save 10+ hours per week.",
        icon: AutomationIcon
      },
      {
        title: "Fast Implementation",
        description: "We've helped clients complete audits in under 7 days and reduced manual compliance hours by over 30 hours per month.",
        icon: SpeedIcon
      }
    ]
  },
  ...
  customers: {
    title: "Who We Serve",
    description: "Our solutions are designed for organizations that value security as a strategic enabler",
    items: [
      "Tech Startups and Scale-ups",
      "AI-focused Companies",
      "SaaS, Fintech, and Healthtech Businesses",
      "SMBs and Mid-market Organizations",
      "Companies in Finance, Healthcare, Energy, and Manufacturing"
    ],
    paragraph: "Our clients value speed to certification, cost-effectiveness, and proactive risk visibility that builds trust with their customers and partners. We help them overcome the high cost and complexity of compliance, fragmented tools, slow time to market, and fear of losing enterprise deals due to insufficient security posture."
  },
